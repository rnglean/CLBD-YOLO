def bbox_mpdiou(box1, box2, xywh=True, mpdiou_hw=1, eps=1e-7):
    """
    Calculate MPDIoU between two sets of bounding boxes.

    Args:
        box1: Predicted bounding boxes.
        box2: Ground-truth bounding boxes.
        xywh: If True, boxes are represented as (x, y, w, h).
        mpdiou_hw: Normalization factor used in MPDIoU.
